...
Start with this list. Suppose we want the first element of the first list, second of the second, third of the third.
</div>
...
<div class="notes">
Now an example just to show you some of what's possible with `purrr` and functional programming.
</div>
